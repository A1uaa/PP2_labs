...
background_top = (175, 215, 70)  # Цвет верхнего уровня фона
background_bottom = (175, 215, 100)  # Цвет нижнего уровня фона
snake_colour = (100, 97, 250)  # Цвет змейки
food_colour = (255, 0, 0)  # Цвет еды 
